...
echo ("
		...
		* Clear Uniform Resource Locator With Path-To-Cerberus Directory:<BR>
		...
		<B>[&nbsp;!&nbsp;]&nbsp;If you are unable to install the S.Q.L. Tables please click [ <A HREF=\"System/Default/MySQL/index.php\" TITLE=\"View S.Q.L. Data Generator Script\" TARGET=\"_NEW\">here</A> ], Copy the S.Q.L. Tables and Manually Paste them into your S.Q.L. Manager / Editor.</B><BR><BR>
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES	= array();

$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[0]		= "
CREATE TABLE \"$_POST_PREFIX\"_ahref (
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[1]		= "
CREATE TABLE \"$_POST_PREFIX\"_applications (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[2]		= "
CREATE TABLE \"$_POST_PREFIX\"_articles (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[10]		= "
CREATE TABLE \"$_POST_PREFIX\"_banned_ip_addresses (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
ip_address VARCHAR(128),
PRIMARY KEY (id)
);";

$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[3]		= "
CREATE TABLE \"$_POST_PREFIX\"_blocks (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[4]		= "
CREATE TABLE \"$_POST_PREFIX\"_categories (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[5]		= "
CREATE TABLE \"$_POST_PREFIX\"_comments (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[14]		= "
CREATE TABLE \"$_POST_PREFIX\"_custom_pages (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[6]		= "
CREATE TABLE \"$_POST_PREFIX\"_files (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[7]		= "
CREATE TABLE \"$_POST_PREFIX\"_forum_forum (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[8]		= "
CREATE TABLE \"$_POST_PREFIX\"_forum_post (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[9]		= "
CREATE TABLE \"$_POST_PREFIX\"_forum_topic (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[11]		= "
CREATE TABLE \"$_POST_PREFIX\"_links (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[12]		= "
CREATE TABLE \"$_POST_PREFIX\"_members (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
member_access_level CHAR(1),
member_aim VARCHAR(250),
member_avatar VARCHAR(50),
member_banned_status CHAR(1),
member_city VARCHAR(250),
...
member_yim VARCHAR(250),
PRIMARY KEY (id)
);";

$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[13]		= "
CREATE TABLE \"$_POST_PREFIX\"_news (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[15]		= "
CREATE TABLE \"$_POST_PREFIX\"_polls (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
poll_reply_1 VARCHAR(250),
poll_reply_2 VARCHAR(250),
poll_reply_3 VARCHAR(250),
poll_reply_4 VARCHAR(250),
poll_reply_5 VARCHAR(250),
poll_result_1 CHAR(10),
poll_result_2 CHAR(10),
poll_result_3 CHAR(10),
poll_result_4 CHAR(10),
poll_result_5 CHAR(10),
poll_question VARCHAR(250),
PRIMARY KEY (id)
);";

$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[16]		= "
CREATE TABLE \"$_POST_PREFIX\"_private_messages (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[17]		= "
CREATE TABLE \"$_POST_PREFIX\"_ranks (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
rank_1 VARCHAR(100),
rank_2 VARCHAR(100),
rank_3 VARCHAR(100),
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[18]		= "
CREATE TABLE \"$_POST_PREFIX\"_settings (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[19]		= "
CREATE TABLE \"$_POST_PREFIX\"_shouts (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[20]		= "
CREATE TABLE \"$_POST_PREFIX\"_statistics (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[21]		= "
CREATE TABLE \"$_POST_PREFIX\"_news_submissions (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[22]		= "
CREATE TABLE \"$_POST_PREFIX\"_system_message (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
$_MAIN_INSTALLATION_DEFAULT_SQL_TABLES					= str_replace('"', '', $_MAIN_INSTALLATION_DEFAULT_SQL_TABLES);

/*
 ===========================
 + Increment S.Q.L. Objects
 ===========================
*/

for ($i = 0; $i < sizeof($_MAIN_INSTALLATION_DEFAULT_SQL_TABLES); $i++)
	mysql_query($_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[$i]) or die(mysql_error());
...
echo ("
	...
	* Administrator Username: [ Username ]<BR>
	<INPUT TYPE=\"text\" NAME=\"post_administrator_username\" MAXLENGTH=\"50\"><BR>
	* Administrator Password: [ Maximum Length: 32 Characters, Alpha-Numeric ]<BR>
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Articles','001','?Application&#61;Articles&amp;DisplayID&#61;All')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Contact','002','?Application&#61;Contact_Admin')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Documentation','003','?Application&#61;Documentation')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Files','004','?Application&#61;Files&amp;CategoryID&#61;All')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Forum','005','?Application&#61;Forum&amp;ForumID&#61;All')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Legal','006','?Application&#61;Legal')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Links','007','?Application&#61;Links&amp;DisplayID&#61;All')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Login','008','?Application&#61;Login')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Member List','009','?Application&#61;Members')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Members Online','010','?Application&#61;Members_Online')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('News','011','?Application&#61;News')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Polls','012','?Application&#61;Polls&amp;PollID&#61;All')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Referrers','013','?Application&#61;Referrers')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('RSS Feed','014','RSS.php')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Register','015','?Application&#61;Register')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Search','016','?Application&#61;Search')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Statistics','017','?Application&#61;Statistics')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Submit Link','018','?Application&#61;Links&amp;SubmitLink&#61;Yes')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Submit News','019','?Application&#61;Submit_News')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Upload File','020','?Application&#61;Upload')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ahref(ahref_name,ahref_row,ahref_url)VALUES('Welcome!','021','?customApplication&#61;1')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('All_News','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('All_Shouts','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Articles','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Change_Password','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Comment','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Contact_Admin','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('cPanel','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Documentation','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Edit_Profile','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('E-Mail','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Files','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Forum','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Friend','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Legal','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Links','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('List','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Login','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Members','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Members_Online','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('News','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Polls','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Private_Files','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Private_Message','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Profile','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Referrers','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Register','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Reset_Password','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Search','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Send_Friend','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Statistics','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Submit_News','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('System_Message','0','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Upload','1','1')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_applications(application_file_name,application_file_permission,application_file_status)VALUES('Webspace','1','1')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Articles','0','3','1','<CENTER><B>Articles</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Banned','0','4','1','<CENTER><B>Banned IP Addresses</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Cerberus','1','1','1','<CENTER><B>Cerberus Content</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Files','1','3','1','<CENTER><B>Files</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Language','1','6','1','<CENTER><B>Set Language</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Modules','0','1','1','<CENTER><B>Modules</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Members','0','2','1','<CENTER><B>Member Panel</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Member_List','1','4','1','<CENTER><B>Newest Members</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Polls','1','2','1','<CENTER><B>Polls</B></CENTER><HR>')");
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Shouts','1','5','1','<CENTER><B>Shout Messages</B></CENTER><HR>')");
...
copy("System/Default/Register/Register.html","Member/$_POST_ADMINISTRATOR_USERNAME/index.html");
	...
	echo ("<FONT COLOR=\"#CD0000\">[&nbsp;*&nbsp;]</FONT> Installing Custom Page... Please Wait.<BR>");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_custom_pages(custom_page_data,custom_page_name,custom_page_time)VALUES('Hello and welcome to Cerberus! If you\'re reading this then Cerberus was successfully installed!','Welcome To Cerberus','$_GLOBAL_DATE')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_ranks(rank_1,rank_2,rank_3,rank_4,rank_5)VALUES('Boann','Brigit','Cliodna','Lugh','Danu')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_statistics(statistics_number_of_hits,statistics_start_date)VALUES('1','$_GLOBAL_DATE')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_forum_forum(forum_access_level,forum_date,forum_description,forum_title)VALUES('1','$_GLOBAL_DATE','This is an Example Forum.','Example Forum #1')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_forum_topic(topic_access_level,topic_date,topic_description,topic_forum_id,topic_last_post,topic_last_poster,topic_title)VALUES('1','$_GLOBAL_DATE','This is an Example Topic.','1','$_GLOBAL_DATE','Cerberus','Example Topic #1 Within Example Forum #1')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_forum_post(post_access_level,post_author,post_data,post_date,post_last_edit,post_topic_id)VALUES('1','Cerberus','This is an Example Post -- you can Administer the Forum via the Administration cPanel.','$_GLOBAL_DATE','$_GLOBAL_DATE','1')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_categories(category_description,category_time,category_title)VALUES('This is an Example File Category -- You can Delete this from the Administration cPanel.','$_GLOBAL_DATE','Example File Category.')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_articles(article_author,article_data,article_time,article_title)VALUES('Cerberus','This is an Example Article -- You can Delete this from the Administration cPanel.','$_GLOBAL_DATE','Example Article')");
...
$DB->query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_news(news_author,news_avatar,news_data,news_mood,news_music,news_rss_rfc,news_time,news_title)VALUES('Cerberus','Default.png','This is an Example News Item -- You can Delete this from the Administration cPanel.','None','None','Wed, 05 Aug 2009 15:04:18 -0700','$_GLOBAL_DATE','Example News')");
