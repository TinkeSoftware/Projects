...
/*
 ...
 + - File Version:  0.4 - Friday, June, 7, 2019.
 + ---
 +%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 +%%%()()%%()()()%%()()()%%()()()%%()()()%%()()()%%()%%()%%%%%%()()()%%%%%%%%%%%%
 +%%()%%%%%()%%%%%%()%%()%%()%%()%%()%%%%%%()%%()%%()%%()%%%%%%()%%%%%%%%%%%%%%%%
...
$_GLOBAL_LAYOUT_1			= "
		<CENTER><A HREF=\"?$_INTERNAL_USER_MODULE&#61;News\"><IMG SRC=\"Theme/$_THEME_DIRECTORY/$_THEME_DIRECTORY_IMAGE/Banner/Banner_1.png\" WIDTH=\"75%\" TITLE=\"Open Application :: News\" ALT=\"Open Application :: News\"></A></CENTER>
